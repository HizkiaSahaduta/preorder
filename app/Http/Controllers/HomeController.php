...
class HomeController extends Controller
{
    ...
    public function customerDashboard (Request $request) { 
        ...
        if ($txtGroup == 'CUSTOMER' && !$txtCustID) {
            ...
            if ($count_cust > 1) {
                ...
                $url = "https://svr01.kencana.org/service/api/dashboardOrderCustGroup?custid=".$txtCustID."&flag=N";
                $curl = curl_init();
                ...
                if ($err) {
                    ...
                    <p class="card-text">by Customer Group</p>';
                    ...
                    $cust_grp_name = DB::table('customer')
                                    ->selectRaw('LTRIM(RTRIM(cust_name)) as cust_name, TRIM(RTRIM(cust_id)) as cust_id')
                                    ->where('cust_id', '=', $cust_grp_id_tmp)
                                    ->where('active_flag','=', 'Y')
                                    ->groupBy('cust_id')
                                    ->groupBy('cust_name')
                                    ->value('cust_id');
                    ...
                    $result =   DB::select(DB::raw("select LTRIM(RTRIM(cust_id)) as cust_id, LTRIM(RTRIM(cust_name)) as cust_name 
                                from customer where cust_id in ($list_custid) and active_flag = 'Y'"));
                    ...
                    foreach ($result as $result) {
                        ...
                        <div class="item-timeline timeline-new">
                            <div class="t-dot">
                                <div class="t-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg></div>
                            </div>
                            <div class="t-content">
                                <div class="t-uppercontent">
                                    <h5><a href="javascript:void(0);" class="chooseCustomer" data-id="'.$result->cust_id.'">'.$result->cust_name.'</a></h5>
                                </div>
                                <span class="listCust">Cust. Group of '.$cust_grp_name.'</span>
                            </div>
                        </div>';

                    }

                    return response()->json(['list_customer' => $value,
                                            'NotShipYet' => $NotShipYet,
                                            'UnpaidInv' => $UnpaidInv,
                ...
                if ($err) {
                        ...
                        <div class="invoice-box">
                            <div class="inv-detail">      
                                <div class="info-detail-1">
                                    ...
                                    <p class="text-primary">'.$data->order_blm_kirim_jml.'</p>
                                </div>                                  
                                <div class="info-detail-1">
                                    <p class="text-primary">Weight</p>
                                    <p class="text-primary">'.$data->order_blm_kirim_wgt.'</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="invoice-box">
                            <div class="inv-detail">      
                                <div class="info-detail-1">
                                    ...
                                    <p class="text-primary">'.$data->inv_kurang_bayar_inv.'</p>
                                </div>                                  
                                <div class="info-detail-1">
                                    <p class="text-primary">IDR-Million</p>
                                    <p class="text-primary">'.$data->inv_kurang_bayar_piutang.'</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="invoice-box">
                            <div class="inv-detail">      
                                <div class="info-detail-1">
                                    ...
                                    <p class="text-primary">'.$data->siap_kirim_lpm.'</p>
                                </div>                                  
                                <div class="info-detail-1">
                                    <p class="text-primary">Weight</p>
                                    <p class="text-primary">'.$data->siap_kirim_wgt.'</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="invoice-box">
                            ...
                            <div class="inv-detail">      
                                <div class="info-detail-1">
                                    ...
                                    <p class="text-primary">'.$data->inv_last_year_amt_total.'</p>
                                </div>                                  
                                <div class="info-detail-1">
                                    <p class="text-warning">Total Paid</p>
                                    <p class="text-warning">'.$data->inv_last_year_amt_paid.'</p>
                    ...
                    // $list_order_blm_kirim = $data->list_order_blm_kirim;
                    $list_prod_last_year = $data->list_prod_last_year;

                    // foreach ($list_order_blm_kirim as $list_order_blm_kirim) {

                    //     $list_order_blm_kirim_val .= '
                    //     <div class="item-timeline timeline-new">
                    //         <div class="t-dot">
                    ...
                    //         <div class="t-content">
                    //             <div class="t-uppercontent">
                    //                 <h5>'.$list_order_blm_kirim->cust_name.'</h5>
                    //             </div>
                    //             <p>BookId: <strong class="badge outline-badge-primary" data-id="'.$list_order_blm_kirim->book_id.'">'.$list_order_blm_kirim->book_id.'</strong></p>
                    //         </div>
                    //         <div class="tags">
                    //             <div class="badge badge-primary">'.$list_order_blm_kirim->jml_order.'</div>
                    //             <div class="badge badge-success">'.number_format($list_order_blm_kirim->wgt_outstanding,2,",",".").' KG</div>
                    //         </div>
                    //     </div>';
