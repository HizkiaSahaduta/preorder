...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        ...
        @if(Session::get('GROUPID') == 'CUSTOMER' && $count_cust > 1)
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-activity-three">
                    <div class="widget-heading">
                        <h5 class="">List Customer Group</h5>
                    </div>
                    <div class="widget-content">
                        <div class="mt-container mx-auto">
                            <div class="timeline-line" id="ListCustomer">  
                                ...
                                <div class="item-timeline timeline-new">
                                    ...
                                    <div class="t-content">
                                        <div class="t-uppercontent">
                                            <h5><a href="javascript:void(0);" class="chooseCustomer text-danger">N/A</a></h5>
                                        </div>
                                        <span class="listCust text-danger">N/A</span>
                                    </div>
                                </div>
                    ...
                    <div class="widget-heading" id ="divRefresh" style="padding: 10px 32px; padding-bottom: 15px; border-top: 1px dashed #e0e6ed; display:none;">
                        <a href="javascript:void(0);" class="btn btn-dark" id="refresh">
        ...
        @if(Session::get('GROUPID') == 'CUSTOMER' && $count_cust < 2)
