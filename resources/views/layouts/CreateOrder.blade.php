                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('CreateOrder') }}">Create Order</a></li>
                        </ol>
                    </nav>
                </div>
            </li>
                    ...
                    <div id="example-vertical">
                        ...
                        <section id='section_1'>
                            <div class="form-row mb-6">
                                ...
                                <input type="hidden" id="txtStr1">
                                <input type="hidden" id="txtDiscLoco">
                            </div>

                            <hr class="style">

                            <div class="form-row mb-6">
                                <div class="form-group col-md-5 col-5" style="display: none">
                                    <label class="text-dark" for="txtStrata">Strata</label>
                                    <input class="form-control basic" name="txtStrata" id="txtStrata" readonly>
                                </div>
                                <div class="form-group col-md-12 col-12">    
                                    <label class="text-dark" for="txtShipTerm">Shipment Condition</label>  
                            ...
                            <div class="form-row mb-6">
                                ...
                                <div class="form-group col-md-8 col-8">
                                    <label class="text-dark" for="txtCustName">Customer</label>
                            ...
                            <div class="form-row mb-6">
                                <div class="form-group col-md-12">
                                    <label class="text-dark" for="txtConsignee">Delivery Address</label>
                            ...
                            <div class="form-row mb-6">
                                <div class="form-group col-md-6 col-6" style="display: none">
                                ...
                                <div class="form-group col-md-12 col-12">
                                    <label class="text-dark" for="txtPayment">Customer PO Number</label>
                                    <input type="text" name="txtCustPoNumber" id="txtCustPoNumber" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-row mb-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" id="txtAddRemark" name="txtAddRemark" rows="3"></textarea>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id='section_2'>
                            ...
                            <div id="AddItem" style="display: none">
                                ...
                                <p class="p_style">
                                    If you wanna adding an item without searching product first, you can use <a href="javascript:void(0)" id="byremark" style="color: #8dbf42; font-weight: bold;">this</a> instead.
                                </p>
                                <div class="form-row mb-6">
                                    <div class="form-group col-md-6 col-6">
                                ...
                                <div class="form-row mb-6">
                                    <div class="form-group col-md-6 col-6">
                                        <label class="text-dark" for="txtBrandCoat">Coating Mass (AZ)</label>
                                ...
                                <div class="form-row mb-6">
                                    <div class="form-group col-md-6 col-6">
                                        <label class="text-dark" for="txtThickness">Thickness</label>
                            ...
                            <div id="ItemProperty" style="display: none">
                                ...
                                <div class="form-row mb-6" id="ApplNote" style="display: none">
                                    <div class="form-group col-md-12">
                                        <label class="text-dark" for="txtApplNote">Application</label>
...
function listConsignee(id){
    ...
    if (!id) {
        ...
        $('#txtConsignee').select2({
            placeholder: 'Choose delivery address below',
            allowClear: true
        });
    }
...
function listCoat(){
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function(index, element) {
            $('select[name="txtBrandCoat"]').append('<option value="'+element.coat_mass+'">AS'+element.coat_mass+'</option>');
            });
        }
    });
...
function listAppl(){
    ...
    $('#txtApplNote').select2({
        placeholder: 'Choose application below',
        allowClear: true
    });
...
$(document).ready(function() {
    ...
    $("#example-vertical").steps({
        ...
        onStepChanging: function (event, currentIndex, newIndex)
        {
            ...
            {
                swal('Whops', 'Please choose Shipment Condition first', 'error')
                return false;
                
            }
            if (newIndex === 1 && !txtConsignee)
            {
                swal('Whops', 'Please choose Delivery Address first', 'error')
                return false;
    ...
    listProjectFlag(); listPayment(); listShipTerm();
